    ...
    return ( 
        <Section className="lg:bg-light-blue">
            <Container className="flex flex-col lg:flex-row gap-6 lg:gap-10 justify-between text-black">
                ...
                <div className="flex-1 bg-light-blue lg:bg-none p-2 mx-auto w-full max-w-[340px] md:max-w-[450px] lg:max-w-none">
                    <Heading3 className="mb-6">{t('Philosophy.block_1.title')}</Heading3>
                    <Paragraph>{t('Philosophy.block_1.subtitle')}</Paragraph>
                </div>
                <div className="flex-1 bg-light-blue lg:bg-none p-2 mx-auto w-fullmax-w-[340px] md:max-w-[450px] lg:max-w-none">
