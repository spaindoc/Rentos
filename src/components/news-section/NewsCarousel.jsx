          ...
          {newsItems.map((item) => (
            <div key={item._id} className={styles.slide}>
              <div className='h-full max-w-[380px] w-full flex flex-col'>
                ...
                {/* Text: дата + заголовок один под другим */}
                <div className='py-2 flex flex-col gap-2'>
                  <p className='text-base 2xl:text-lg font-roboto text-black mb-1'>
                    {item.date}
                  </p>
                  <p
                    className='text-lg font-oswald uppercase whitespace-pre-line'
